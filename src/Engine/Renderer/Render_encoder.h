...
namespace Engine {
    ...
    namespace Render {
        ...
        public:
            ...
            virtual void draw_instanced(const std::shared_ptr<Engine::Material>& material,const std::shared_ptr<Engine::Vertex_array>& vertex_array, uint32_t instances) const = 0;
        ...
        public:
            ...
            void draw_instanced(const std::shared_ptr<Engine::Material>& material,const std::shared_ptr<Engine::Vertex_array> &vertex_array, uint32_t instances) const override;
        private:
