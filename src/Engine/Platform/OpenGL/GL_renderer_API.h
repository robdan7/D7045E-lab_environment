...
//            void draw_streamed(std::shared_ptr<Vertex_array> vertex_array, int count, int instances) override;
            void draw_indexed(std::shared_ptr<Engine::Vertex_array> vertex_array,Polygon_type polygon_type, int instances) override;

            void draw_streamed(std::shared_ptr<Engine::Vertex_array> vertex_array, Polygon_type polygon_type, uint32_t start_vertex,
